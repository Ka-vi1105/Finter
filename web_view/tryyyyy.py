...
cur.execute("SELECT * FROM logs_table ORDER BY id DESC LIMIT 75")
table = cur.fetchall()
df3 = pd.DataFrame([[ij for ij in i] for i in table])
...
counters = html.Div([
    ...
    ], style={'background-color': '#0000ff', 'width': '310px', 'border-radius': '15px', 'box-shadow': '2px 2px 2px 2px #060a09'}),
    ...
    ], style={'background-color': '#ffa500', 'width': '310px', 'border-radius': '15px', 'box-shadow': '2px 2px 2px 2px #060a09'}),
    ...
    ], style={'background-color': '#8d30eb', 'width': '310px', 'border-radius': '15px',  'box-shadow': '2px 2px 2px 2px #060a09'}),
    ...
    ], style={'background-color': '#ff0000', 'width': '310px', 'border-radius': '15px', 'box-shadow': '2px 2px 2px 2px #060a09'}),
    ...
    ], style={'background-color': '#008000', 'width': '310px', 'border-radius': '15px', 'box-shadow': '2px 2px 2px 2px #060a09'}),
...
app.layout = html.Div([
    ...
    html.Div([
              ...
              dash_table.DataTable(
                  ...
                  style_cell=dict(textAlign='left', lineColor='red'),
                  style_header=dict(backgroundColor='#b076ea'),
